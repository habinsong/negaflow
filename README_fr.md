...
<p align="center">
  ...
  <a href="#téléchargement"><img src="https://img.shields.io/badge/version-1.1.5-EF8B26" alt="version 1.1.5"></a>
...
|---|---|
| `negaflow-1.1.5-mac-universal.pkg` | macOS 14 ou ultérieur, Apple Silicon et Intel |
| `negaflow-1.1.5-mac-arm64.pkg` | macOS 14 ou ultérieur, Apple Silicon uniquement |
| `negaflow-1.1.5-win-x64.exe` | Windows 11 24H2 ou plus récent, x64 |
