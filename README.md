...
| File | Runs on |
|---|---|
| `negaflow-1.1.5-mac-universal.pkg` | macOS 14 or later, Apple Silicon and Intel |
| `negaflow-1.1.5-mac-arm64.pkg` | macOS 14 or later, Apple Silicon only |
| `negaflow-1.1.5-win-x64.exe` | Windows 11 24H2 or later, x64 |
