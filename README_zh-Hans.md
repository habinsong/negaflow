...
<p align="center">
  ...
  <a href="#下载"><img src="https://img.shields.io/badge/version-1.1.2-EF8B26" alt="版本 1.1.2"></a>
...
| 安装文件 | 适用环境 |
|---|---|
| `negaflow-1.1.2-mac-universal.pkg` | macOS 14 及以上，Apple Silicon 和 Intel |
| `negaflow-1.1.2-mac-arm64.pkg` | macOS 14 及以上，仅 Apple Silicon |
