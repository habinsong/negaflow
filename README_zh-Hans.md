...
<p align="center">
  ...
  <a href="#下载"><img src="https://img.shields.io/badge/version-1.1.5-EF8B26" alt="版本 1.1.5"></a>
...
| 安装文件 | 适用环境 |
|---|---|
| `negaflow-1.1.5-mac-universal.pkg` | macOS 14 及以上，Apple Silicon 和 Intel |
| `negaflow-1.1.5-mac-arm64.pkg` | macOS 14 及以上，仅 Apple Silicon |
| `negaflow-1.1.5-win-x64.exe` | Windows 11 24H2 或更高，x64 |
