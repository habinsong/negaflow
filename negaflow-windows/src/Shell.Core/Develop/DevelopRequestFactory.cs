...
public static partial class DevelopRequestFactory
{
        ...
        uint proxyInputLongEdge = 0U)
    {
        ...
        return Succeed(droppedStaleDefectEdits, new DevelopExportRequest
        {
            ...
            ScannerProfileId = uninvertedSource || DevelopTargets.IsCustom(developTarget) ? null : frame.Base.ScannerProfileId,
            ...
            DevelopTarget = developTarget switch
            {
                ...
                DevelopTarget.Emulsion => DevelopTargetMode.Emulsion,
                DevelopTarget.Reversal => DevelopTargetMode.Reversal,
                DevelopTarget.DyeTransfer => DevelopTargetMode.DyeTransfer,
                DevelopTarget.SkipBleach => DevelopTargetMode.SkipBleach,
                DevelopTarget.PlateGlass => DevelopTargetMode.PlateGlass,
                DevelopTarget.AmberGlass => DevelopTargetMode.AmberGlass,
                DevelopTarget.Ultramarine => DevelopTargetMode.Ultramarine,
                DevelopTarget.Terracotta => DevelopTargetMode.Terracotta,
                DevelopTarget.Celadon => DevelopTargetMode.Celadon,
                DevelopTarget.Nacre => DevelopTargetMode.Nacre,
                DevelopTarget.Dichroic => DevelopTargetMode.Dichroic,
                DevelopTarget.Wetzlar => DevelopTargetMode.Wetzlar,
                DevelopTarget.Classic => DevelopTargetMode.Classic,
                DevelopTarget.Studio => DevelopTargetMode.Studio,
                DevelopTarget.Rochester => DevelopTargetMode.Rochester,
                DevelopTarget.SlideShow => DevelopTargetMode.SlideShow,
                DevelopTarget.Cinema => DevelopTargetMode.Cinema,
                DevelopTarget.PointAndShoot => DevelopTargetMode.PointAndShoot,
