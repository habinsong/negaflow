...
internal static class VectorIconPaths
{
    internal static string Data(VectorIconKind kind) => kind switch
    {
        ...
        // 'ㄱ' 자 한 획과 그 끝의 화살촉입니다. 아래에서 올라와 위에서 <b>오른쪽</b>으로
        // 꺾이고, 화살촉이 오른쪽을 가리킵니다.
        //
        // 앞 판은 원호(A) 에 화살촉을 붙였는데, 작은 크기에서 원호가 거의 닫힌 원으로
        // 보이고 화살촉이 원에 묻혀 <b>새로고침 단추</b>처럼 보였습니다. 곧은 선 넷이면
        // 16px 에서도 방향이 분명합니다.
        VectorIconKind.RotateRight =>
            "M 6,17 L 6,9 L 16,9 M 12.5,5.5 L 16,9 L 12.5,12.5",

        // 위의 좌우 대칭 — 화살촉이 <b>왼쪽</b>을 가리킵니다.
        VectorIconKind.RotateLeft =>
            "M 18,17 L 18,9 L 8,9 M 11.5,5.5 L 8,9 L 11.5,12.5",
