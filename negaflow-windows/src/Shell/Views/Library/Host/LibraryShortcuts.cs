    ...
    internal bool Invoke(WorkflowShortcutAction action)
    {
        ...
        switch (action)
        {
            ...
            case WorkflowShortcutAction.ProcessBwPositive:
                view.ApplyDevelopProcessShortcut(action);
                return true;
            case WorkflowShortcutAction.TargetMain:
                view.ApplyDevelopTargetShortcut(DevelopTarget.Main);
                return true;
            case WorkflowShortcutAction.TargetPrint:
                view.ApplyDevelopTargetShortcut(DevelopTarget.Print);
                return true;
            case WorkflowShortcutAction.TargetNoritsu:
                view.ApplyDevelopTargetShortcut(DevelopTarget.Noritsu);
                return true;
            case WorkflowShortcutAction.TargetSp3000:
                view.ApplyDevelopTargetShortcut(DevelopTarget.Sp3000);
                return true;
            case WorkflowShortcutAction.TargetF135:
                view.ApplyDevelopTargetShortcut(DevelopTarget.F135);
                return true;
            case WorkflowShortcutAction.TargetHr:
                view.ApplyDevelopTargetShortcut(DevelopTarget.Hr);
                return true;
            case WorkflowShortcutAction.TargetExpired:
                view.ApplyDevelopTargetShortcut(DevelopTarget.Rescue);
                return true;
