...
nf_status_t NF_CALL nf_develop_export_v37(
    const nf_develop_export_request_v37* const request,
    ...
    if (!prepare_result_v35(
            request == nullptr ? nullptr : &request->v36.v35,
            result,
            status)) {
        return status;
    }
    if (request->v36.v35.v34.v33.v32.v31.v30.v29.v28.v27.v26.v25.v24.v21.v20.v19.v18
    ...
    if (!map_request_v37(*request, true, pipeline_request, mapping_result)) {
