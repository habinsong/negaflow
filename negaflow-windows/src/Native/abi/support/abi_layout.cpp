...
static_assert(sizeof(nf_develop_export_request_v36) == 5136U);
static_assert(offsetof(
...
static_assert(sizeof(nf_grain_mend_detection_v4) == 88U);
static_assert(sizeof(nf_grain_mend_review_hit_v1) == 16U);
static_assert(offsetof(nf_grain_mend_review_hit_v1, component_index) == 8U);
static_assert(sizeof(nf_grain_mend_accepted_region_v1) == 40U);
static_assert(offsetof(nf_grain_mend_accepted_region_v1, mask_byte_count) == 24U);
static_assert(offsetof(nf_grain_mend_accepted_region_v1, included_component_count) == 32U);
...
static_assert(offsetof(nf_flatbed_frame_detection_v1, straighten_angle) == 56U);
