...
internal static class ColorRecipeJsonReader
{
        ...
        out DevelopTarget developTarget)
    {
        ...
        developTarget = element.GetString() switch
        {
            ...
            "emulsion" => DevelopTarget.Emulsion,
            "reversal" => DevelopTarget.Reversal,
            "dye-transfer" => DevelopTarget.DyeTransfer,
            "skip-bleach" => DevelopTarget.SkipBleach,
            "plate-glass" => DevelopTarget.PlateGlass,
            "amber-glass" => DevelopTarget.AmberGlass,
            "ultramarine" => DevelopTarget.Ultramarine,
            "terracotta" => DevelopTarget.Terracotta,
            "celadon" => DevelopTarget.Celadon,
            "nacre" => DevelopTarget.Nacre,
            "dichroic" => DevelopTarget.Dichroic,
            "wetzlar" => DevelopTarget.Wetzlar,
            "classic" => DevelopTarget.Classic,
            "studio" => DevelopTarget.Studio,
            "rochester" => DevelopTarget.Rochester,
            "slide-show" => DevelopTarget.SlideShow,
            "cinema" => DevelopTarget.Cinema,
            "point-and-shoot" => DevelopTarget.PointAndShoot,
            _ => (DevelopTarget)(-1),
        };
