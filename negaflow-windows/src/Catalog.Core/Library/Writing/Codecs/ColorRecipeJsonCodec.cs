    ...
    internal static void Write(JsonObject parameters, LibraryFrameEdit edit)
    {
        ...
        if (edit.DevelopTarget is { } target)
        {
            parameters[LibraryFrameReader.DevelopTargetName] = target switch
            {
                ...
                DevelopTarget.Emulsion => "emulsion",
                DevelopTarget.Reversal => "reversal",
                DevelopTarget.DyeTransfer => "dye-transfer",
                DevelopTarget.SkipBleach => "skip-bleach",
                DevelopTarget.PlateGlass => "plate-glass",
                DevelopTarget.AmberGlass => "amber-glass",
                DevelopTarget.Ultramarine => "ultramarine",
                DevelopTarget.Terracotta => "terracotta",
                DevelopTarget.Celadon => "celadon",
                DevelopTarget.Nacre => "nacre",
                DevelopTarget.Dichroic => "dichroic",
                DevelopTarget.Wetzlar => "wetzlar",
                DevelopTarget.Classic => "classic",
                DevelopTarget.Studio => "studio",
                DevelopTarget.Rochester => "rochester",
                DevelopTarget.SlideShow => "slide-show",
                DevelopTarget.Cinema => "cinema",
                DevelopTarget.PointAndShoot => "point-and-shoot",
