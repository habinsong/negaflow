...
//
// **참조를 옮겨 적지 않습니다.** 진짜 CPU 함수 `apply_scanner_target_grade` 를
// 그대로 부르고 그 결과와 겨룹니다. 프로파일 표도 진짜 것이 쓰입니다.
//
// **엔진에서 가장 비싼 커널이고, 가장 긴 사슬입니다.** 화소마다 Lab 왕복 세 번 ×
...
//
// **이 숫자들을 근거 없이 올리지 마십시오.** 올려야 한다면 먼저 "누적이 커진 것인가,
...
void grade_matches_cpu(
    ...
    // 최악 화소의 **입력 밝기**를 같이 찍습니다. 이 사슬은 암부에서 조건수가 큽니다 —
