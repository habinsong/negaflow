...
**남은 약 500 MB 의 출처는 미상입니다.** 가설 셋(썸네일 JPEG 캐시 / catalog JSON payload /
렌더 버퍼의 LOH 누적)을 전부 재서 전부 기각했습니다 — 표가
`../verification/2026-08-13-library-scale.md` 에 있습니다. **더 추측하지 말고 메모리
프로파일러를 붙이십시오.** 그리고 cold(약 1,255 MB)와 warm(약 858 MB)을 섞어 비교하지
마십시오.
