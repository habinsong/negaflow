...
| 가이드 | **완료** (아래 5.2) | 자동과 `RegionDefectOverlay` 공유 — 앱에서 동작 확인됨 |
| 브러시 | `DefectHealBrush` 있음 | **없음** — 빨간 칠 오버레이·컨트롤 바 히트 0 |
| 복제 도장 | `defect_clone_stamp.cpp` 있음 | **없음** — 원 커서·Alt 십자선·크기/경도 바 히트 0 |
| IR | 있음 | 미확인 |
