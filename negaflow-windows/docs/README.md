...
- [소프트 프루프 — 용지와 잉크](implementation/soft-proof.md)
...
- [압축 TIFF LZW·Deflate 의미 사전 검사](implementation/compressed-tiff-preflight.md)
- [WIC TIFF 디코더](implementation/wic-tiff-decoder.md)
- [다중 IFD TIFF 전체 해상도 선택](implementation/multi-directory-tiff.md)
...
- [영역 Defects component repair와 Clone Stamp ABI 경계](implementation/defect-component-repair-v2.md)
...
- [2026-08-10 영역 Defects ABI v18·Clone Stamp v20·Brush v21 검증](verification/2026-08-10-defect-region-pipeline-v18.md)
- [2026-08-10 Defects sidecar v2 검증](verification/2026-08-10-defect-sidecar-v2.md)
- [2026-08-10 Defects source identity ABI v19 검증](verification/2026-08-10-defect-source-identity-v19.md)
- [2026-08-10 네거티브 장면 범위 affine proxy 검증](verification/2026-08-10-negative-scene-range-affine.md)
- [2026-08-10 Auto FilmBase affine sampled-grid 검증](verification/2026-08-10-auto-filmbase-affine.md)
- [2026-08-10 Auto FilmBase 선택·fallback 수학 검증](verification/2026-08-10-auto-filmbase-selection.md)
- [2026-08-10 Auto FilmBase Double 통계 검증](verification/2026-08-10-auto-filmbase-double-statistics.md)
- [2026-08-10 DigitalFilmLook color preset bounded tile 검증](verification/2026-08-10-digital-film-color-preset-tiles.md)
...
- [Windows ICM 실측과 ColorSync 대조](research/colorsync-icm-parity-windows-measurement.md)
...
- [ADR-0026: Deflate는 독립 의미 검사 뒤 WIC에 전달](decisions/0026-bounded-deflate-preflight.md)
- [ADR-0027: 코드 서명 철회, 서명 없는 설치 파일, ARM64 실기는 사용자 담당](decisions/0027-unsigned-installer-and-deferred-arm64.md)
- [ADR-0028: 소프트 프루프는 미리보기 전용, v2 프로파일 흰색은 색소에서 재구성](decisions/0028-soft-proof-preview-only-and-reconstructed-white.md)
