...
| `src/Shell/Views/DevelopWorkspaceView.xaml.cs` | 2,407 | 미해결. 크롭·메타데이터·출력·버전·프리셋·필름 룩·소스 사이드바·톤/색 조정 스택은 분리했다. 캔버스·GrainMend·베이스/기하 카드가 남는다 |
| `tests/Native.UnitTests/develop_export_abi_tests.cpp` | 4,107 | 미해결 |
| `src/Shell/Views/LibraryWorkspaceView.xaml.cs` | 2,835 | 미해결 |
| `src/Shell/Views/DevelopWorkspaceView.xaml` | 836 | 미해결. 소스 사이드바·정보 카드·톤/색 조정 스택 XAML 은 옮겼다. 캔버스·GrainMend·베이스/기하가 남는다 |
...
| P0 | `src/Shell/Views/DevelopWorkspaceView.xaml.cs` | 2,407 | 선택·미리보기·crop·GrainMend·base/geometry·resize·localization | macOS surface 단위 실제 UserControl | 진행 중. 출력·버전·프리셋·필름·소스·정보·톤/색 조정을 옮겼다. 코드비하인드 4,844→2,407, XAML 2,512→836. 아직 500줄 초과 |
...
| P0 | `src/Shell/Views/DevelopWorkspaceView.xaml` | 836 | canvas/crop, histogram/tabs, GrainMend, base/geometry | macOS surface 단위 실제 UserControl; 공유 상태를 partial로 숨기지 않음 | 진행 중. 소스·정보·톤/색 조정 XAML 분리. 아직 500줄 초과 |
