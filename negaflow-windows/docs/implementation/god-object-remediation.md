...
미해결 7개: `develop_export_abi_tests.cpp`, `LibraryWorkspaceView.xaml.cs`, `NativeDevelopExporter.cs`, `develop_export.cpp`, `tiff_probe.cpp`, `LibraryWorkspaceView.xaml`, `PrintWorkspaceView.Composition.cs`.
