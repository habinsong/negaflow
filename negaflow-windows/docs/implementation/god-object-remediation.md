...
| `src/Shell/Views/DevelopWorkspaceView.xaml.cs` | 2,130 | 미해결. 크롭 세션·메타데이터·출력·버전·프리셋·필름 룩·소스 사이드바·톤/색 조정·베이스/기하는 분리했다. 캔버스·GrainMend 가 남는다 |
| `tests/Native.UnitTests/develop_export_abi_tests.cpp` | 4,107 | 미해결 |
| `src/Shell/Views/LibraryWorkspaceView.xaml.cs` | 2,835 | 미해결 |
| `src/Shell/Views/DevelopWorkspaceView.xaml` | 650 | 미해결. 소스·정보·톤/색·베이스/기하 XAML 은 옮겼다. 캔버스·GrainMend 가 남는다 |
...
| P0 | `src/Shell/Views/DevelopWorkspaceView.xaml.cs` | 2,130 | 선택·미리보기·crop 세션·GrainMend·resize·localization | macOS surface 단위 실제 UserControl | 진행 중. 출력·버전·프리셋·필름·소스·정보·톤/색·베이스/기하를 옮겼다. 코드비하인드 4,844→2,130, XAML 2,512→650. 아직 500줄 초과 |
...
| P0 | `src/Shell/Views/DevelopWorkspaceView.xaml` | 650 | canvas/crop overlay, histogram/tabs, GrainMend | macOS surface 단위 실제 UserControl; 공유 상태를 partial로 숨기지 않음 | 진행 중. 소스·정보·톤/색·베이스/기하 XAML 분리. 아직 500줄 초과 |
