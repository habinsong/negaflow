...
| 9 | **언어를 바꿔도 안 바뀜** | **2026-08-20 닫음.** 원인 셋 — [`18`](18-localization.md) |

`SettingsRootView.xaml.cs` 는 **547줄로 500 을 넘었습니다**([`05`](05-god-objects.md) 1절).
설정 탭을 더 붙이기 전에 탭 하나를 파일로 떼십시오.
