...
| GPU | **2026-08-18 파이프라인 연결됨.** 화소별 커널 **12개 + 이웃 원시연산 5개**, 전부 CPU 동치 고정. 톤 7단계와 `film_scan_denoise` 는 **프리뷰·검출에서**, 형태학은 **비트 단위 일치라 언제나** GPU. 속도 미측정·내장 GPU 실기 미확인 | [`04`](04-gpu-plan.md) 0절 · [`13`](13-performance-playbook.md) |
