...
| [`04-gpu-plan.md`](04-gpu-plan.md) | **GPU 이식 계획** — **2026-08-18 다시 씀.** macOS `ChromabaseMetalKernels.swift` 의 `[[stitchable]]` 커널 **32개**(전부 화소별)가 이식 대상. 이웃 연산은 Apple 내장 필터라 **직접 만들어야** 함. D3D11 컴퓨트 · FL 11_0 · `R32G32B32A32_FLOAT` · GPU 상주 |
...
| GPU | **2026-08-18 착수**(`aa0d59f`) — 기반 + 커널 **10개**(톤 단계 7/7 완주). 파이프라인 미연결 | [`04`](04-gpu-plan.md) · [`13`](13-performance-playbook.md) |
