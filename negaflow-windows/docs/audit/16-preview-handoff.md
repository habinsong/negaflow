...
**여기에 단계를 더 붙일 사람에게:** ① 상주 범위는 그것이 채우는 버퍼보다 **먼저**
선언합니다. ② 이미지를 단계에 **넘겨 버릴 때는** 넘기기 직전에
`GpuAccelerator::shared().flush_resident_if(image.pixels.data())` 를 부릅니다.
②가 없어 2026-08-20 에 한 번 더 죽었습니다([`07`](07-user-reported.md) J2.1).
