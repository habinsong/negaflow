...
## 9. `digitalFilmColor` — Windows 가 **다른 알고리즘**입니다 (2026-08-18 발견)
...
> **GPU 로 옮기기 전에 어느 쪽이 맞는지 정해야 합니다.**
...
## 10. [`04`](04-gpu-plan.md) 0.3절의 "선행 조건" 셋이 전부 오판이었습니다 (2026-08-18)
...
## 11. 9절이 **죽은 커널과 산 커널을 견줬습니다** (2026-08-19 정정)
...
## 12. `noritsuTexture` — Windows CPU 판이 **이미 있습니다** (2026-08-19 정정)
...
## 14. `target_grade` **0.00 ms** 는 "빠르다" 가 아니라 **"안 돌았다"** 였습니다 (2026-08-19)
...
### 15.3 `scripts/sync-swift-ui-strings.ps1` 은 **깨져 있고 돌리면 문자열을 지웁니다**
