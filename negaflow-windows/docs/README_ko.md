...
<p align="center">
  <a href="#"><img src="https://img.shields.io/badge/version-1.1.6-EF8B26" alt="버전 1.1.6\"></a>
...
[Releases](https://github.com/habinsong/negaflow/releases)에서 `negaflow-1.1.6-win-x64.exe`를 내려받아 실행합니다.
...
타깃 캡슐 MAIN·HS·SP·F135·HR 뒤에 CS가 있습니다. CS를 누른 뒤 하단 왼쪽 선택기에서 Custom 18개를 두 열로 고릅니다. 11·4·3 묶음 사이에는 구분선이 있고 오른쪽 룩 선택기는 유지합니다. 다른 갈래에서 CS로 들어가면 Emulsion을 선택하며, 이미 Custom인 사진은 현재 선택을 유지합니다.

Custom은 macOS와 같은 custom-3 계수와 문자열 ID를 사용합니다. 사진별 설정과 카탈로그에 실제 타깃을 저장하며 미리보기와 내보내기에 같은 단계를 적용합니다. 폴더 머리줄에서는 기존 적용 버튼으로 선택한 타깃을 일괄 적용합니다.
