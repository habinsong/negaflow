...
<p align="center">
  <a href="#"><img src="https://img.shields.io/badge/version-1.1.5-EF8B26" alt="バージョン 1.1.5\"></a>
...
[Releases](https://github.com/habinsong/negaflow/releases) から `negaflow-1.1.5-win-x64.exe` を入手して実行します。
