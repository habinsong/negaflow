...
| 라이브러리 화면 | **91%** | 카드 격자·정렬·카드 크기·소스 막대·파일 트리·폴더 프로세스 선택기·별점·깃발·가져오기·relink·중복 후보·다중 선택. 필터는 macOS 9개 중 8개. 수동 컬렉션을 만들고 고르고 지웁니다. 스마트 컬렉션·저장된 검색도 만들고 고르고 지웁니다. 남은 것: 미검증 프로파일 필터, 컬렉션 끌어 넣기, 이름 변경 |
