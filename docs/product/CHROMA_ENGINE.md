...
The current product version is `1.1.4`. The edit history and profile schemas will keep going through a validation process before they change in later versions.
