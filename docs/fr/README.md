...
> [!NOTE]
> negaflow 1.1.6 tourne sur macOS et sur Windows. Les deux applications sont écrites séparément pour leur plateforme et rendent la même image à partir du même fichier.
