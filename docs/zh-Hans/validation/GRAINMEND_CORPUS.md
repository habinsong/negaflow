...
如果 Figshare 的文件 CDN 拦截自动请求，可以在数据集页面用 `Download all` 下载 ZIP，然后直接校验
并解开。
只有 ZIP 里的文件名、大小和 Figshare MD5 全部符合固定约定，解压才算完成。
...
素材和论文见 [FILM-R 项目](https://daniela997.github.io/FilmDamageSimulator/)和
