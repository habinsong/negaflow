...
<p align="center">
  ...
  <a href="#ダウンロード"><img src="https://img.shields.io/badge/version-1.1.1-EF8B26" alt="バージョン 1.1.1"></a>
...
| インストーラー | 対象 |
|---|---|
| `negaflow-1.1.1-mac-universal.pkg` | macOS 14 以降、Apple Silicon と Intel |
| `negaflow-1.1.1-mac-arm64.pkg` | macOS 14 以降、Apple Silicon のみ |
