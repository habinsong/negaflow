...
reference scans, logos, packaging, or proprietary scanner software.
...
Adobe Inc., Capture One A/S, or any other trademark owner.

All trademarks, service marks, trade names, logos, and product names are the
...
Bundled scanner-profile files are derived from measured scan samples and are named
after the film stock and scanner model they were measured from, solely to identify
those inputs. They are not, and do not claim to be, the output of, or certified by,
any manufacturer.
...
If you are a rights holder and believe a name is used incorrectly, please open an
issue.
